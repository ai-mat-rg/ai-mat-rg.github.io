...
<div style="background-color: #2E86C1; border-radius: 12px; padding: 12px;">
  <iframe style="border:none;width:100%;border-radius:8px;" id="my-form-mo1aiz" src="https://opnform.com/forms/my-form-mo1aiz"></iframe>
</div>
<script type="text/javascript" onload="initEmbed('my-form-mo1aiz')" src="https://opnform.com/widgets/iframe.min.js"></script>
